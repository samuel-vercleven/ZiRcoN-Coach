...
def main():
    ...
    ev={"status":"DAMAGE_CALCULATION_HIGH_CONFIDENCE","components":[{"calculation_key":"QDamage","damage_type":"MAGIC","activation_condition_status":"NOT_REQUIRED"}]}
    ...
    print("Spell damage resolver synthetic checks: PASS (2/2)")
