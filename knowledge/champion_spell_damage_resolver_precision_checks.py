...
def main():
    ...
    evidence={"status":"DAMAGE_CALCULATION_HIGH_CONFIDENCE","evidence":{"source":"fixture"},"components":[{"component_id":"QDamage","calculation_key":"QDamage","damage_type":"MAGIC","activation_condition_status":"NOT_REQUIRED"}]}
